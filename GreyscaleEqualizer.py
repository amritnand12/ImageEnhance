...
IN_FILE = "photos/2_modified.png"
OUT_FILE = "photos/2_output.png"
# IN_FILE = "photos/opencv_modified.jpg"
# OUT_FILE = "photos/opencv_output.jpg"
...
plt.show()
pillow_img.show(title='greyscale_input')
output_image.show(title='greyscale_output')

# #exp
# import cv2
# im = cv2.imread('{}'.format(OUT_FILE))
# im = im/255.0
